...
description: >
  ...
  "/api-webhook", "event delivery", "signed webhooks", or in Chinese
  "Webhook 设计", "回调签名", "事件推送". Focus on event identity, HMAC, at-least-once
  delivery - not generic REST CRUD style.
---
