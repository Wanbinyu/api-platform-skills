...
description: >
  ...
  or in Chinese "消费者契约", "契约测试", "Pact". Prefer minimal consumer assertions over
  cloning the entire OpenAPI into a test.
---

# Consumer-Driven Contract

> Providers do not guess. Consumers assert. CI enforces.
...
- [ ] At least one interaction with request + min response
